...
/**
 * resolve the settings in a scheme file to the final color values
 * for export in json or js
 * keeping variables nested
 *
 * brushes: {bg: '#000000', fg: '$light-gray'}
 * returns:
 * {'brushes': {bg: '#000000', 'fg': '#999999'}}
 */
function nestedOutputVars(scheme, palette) {
  return _.mapValues(scheme, function(value, key) {
    if(_.isObject(value)) {
      return nestedOutputVars(value, palette);
    }
    return colorForVar(scheme, palette, key, value);
  });
}
...
module.exports = {
  ...
  nestedOutputVars: nestedOutputVars,
